...
def login_sucess():
        ...
        Button(login_success_screen, text="press",command=trt).pack()
...
def main_account_screen():
    ...
    Label(text="Select Your Choice", bg="red", width="300", height="2", font=("Calibri", 40)).pack()
    Label(text="").pack()
    Button(text="Login", height="5", width="50", command = login).pack()
    Label(text="").pack()
    Button(text="Register", height="5", width="50", command=register).pack()
    Button(text='Exit',  height="5", width="50",command=quit).pack()
